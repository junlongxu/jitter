...
public class ProgressView extends View {
	...
	private void init() {
		...
		setBackgroundColor(Color.parseColor("#80D8D8D8"));
		mProgressPaint.setShader(new LinearGradient(0,0,(float) getWidth() * getHeight(),0,
				Color.parseColor("#f54b64"),Color.parseColor("#f78361"),
		...
		mPausePaint.setColor(Color.parseColor("#FFFF4307"));
		mPausePaint.setStyle(Paint.Style.FILL);

		mRemovePaint.setColor(Color.parseColor("#f77e62"));
		mRemovePaint.setStyle(Paint.Style.FILL);

		mThreePaint.setColor(Color.parseColor("#ffffff"));
