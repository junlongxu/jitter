package com.example.jitter.record.view;
...
import com.example.jitter.record.encoder.TextureMovieEncoder;
import com.example.jitter.record.filter.BaseFilter;
import com.example.jitter.record.filter.CameraDrawProcessFilter;
import com.example.jitter.record.filter.CameraFilter;
import com.example.jitter.record.filter.GroupFilter;
import com.example.jitter.record.filter.MagicBeautyFilter;
import com.example.jitter.record.filter.NoneFilter;
import com.example.jitter.record.filter.SlideGpuFilterGroup;
import com.example.jitter.util.EasyGlUtils;
import com.example.jitter.util.MatrixUtils;
