package com.example.jitter.record.encoder;
...
import com.example.jitter.record.filter.MagicCameraInputFilter;
...
//            type = MagicFilterType.NONE;
        ...
        private BaseFilter mShowFilter=new NoneFilter(Utils.mContext.getResources());
