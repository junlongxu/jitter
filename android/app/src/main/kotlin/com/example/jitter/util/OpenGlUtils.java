...
public class OpenGlUtils {
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = Utils.mContext.getResources().openRawResource(resourceId);
    ...
    public static Bitmap drawToBitmapByFilter(Bitmap bitmap, GPUImageFilter filter, int displayWidth, int displayHeight, boolean rotate){
        if(filter == null)
            return null;
