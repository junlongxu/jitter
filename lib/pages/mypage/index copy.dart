...
class _CommentTestState extends State<CommentTest> {
  ...
  List<Map> _commentList = [
    {
      'name': '涂山雏雏',
      'headerImg':
          'http://i2.hdslb.com/bfs/face/cab3e9ec886ff98bc7ac6cb2dca194051895dfba.jpg@52w_52h.webp',
      'content': '你以为我是红细胞，其实我是2222222222222222222222222222222兵库北哒(｀・ω・´)~'
    },
    {
      'name': '漆黑的魂焰魔法使',
      'headerImg':
          'http://i0.hdslb.com/bfs/face/6edd973203eb1ec2b576a3bc61ee555e3757b674.jpg@52w_52h.webp',
      'content': '你说我的头发怎么了啊，啊!'
    },
    {
      'name': '汐华初流艿',
      'headerImg':
          'http://i0.hdslb.com/bfs/face/ecf4c932d4f09ffdcd769b423764210488d03209.jpg@52w_52h.webp',
  ...
  void _sendMessage() {
    _commentList.add({
      'name': '爱吃汉堡包的天残',
      'headerImg':
          'http://i1.hdslb.com/bfs/face/1cb09a8cfec19bd06fbbeba5b978c1ee52a62d3f.jpg@52w_52h.webp',
